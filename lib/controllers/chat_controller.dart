...
class ChatController extends GetxController {
  ...
  sendMessageWithImage(
      File? image, String message, String receiverId, String chatId) async {
  ...
  deleteChat({
    ...
    var response =
        await ApiClient.deleteData(ApiConstants.getChatUser("$conversationId"));
  ...
  blockUser({String? blockUserId, type}) async {
    print("********************************$type");
    var myId = await PrefsHelper.getString(AppConstants.userId);
