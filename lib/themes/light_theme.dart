...
ThemeData light({Color color = const Color(0xFFFF8400)}) => ThemeData(
  fontFamily: 'DM Sans',
  primaryColor: color,
  ...
  colorScheme: ColorScheme.light(
    primary: color,
    secondary: color.withOpacity(0.4),
    // Ensure the brightness matches ThemeData's brightness
    brightness: Brightness.light,
  ),

textTheme: TextTheme(titleSmall: TextStyle(color:AppColors.textColor)),
